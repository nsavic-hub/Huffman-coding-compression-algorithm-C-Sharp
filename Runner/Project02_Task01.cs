...
namespace Runner
{
    class Project02_Task01 : IRunner
    {
        ...
        public void Run(string[] args)
        {
            ...
            DataSerializer<char>.LoadFile(inputFileName, ref inputData);
            ...
            DataSerializer<char>.SaveFile(decodedFileName, decodedData);

            // reload the decodedData from file
            DataSerializer<char>.LoadFile(decodedFileName, ref decodedData);
